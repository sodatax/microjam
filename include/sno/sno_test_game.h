#ifndef SNO_TEST_GAME_H // Include guard must start with the 3-letter id
#define SNO_TEST_GAME_H
...
namespace sno
{
     ...
     */
    class sno_test_game : public mj::game
    {
    public:
        /**
         ...
         */
        sno_test_game(int completed_games, const mj::game_data &data);
